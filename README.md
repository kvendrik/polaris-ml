...
2. We then use a [Watson Machine Learning](https://dataplatform.cloud.ibm.com/docs/content/wsj/analyze-data/ml-overview.html) instance to train a model using this training data.
3. We download this [newly trained model](https://github.com/kvendrik/polaris-ml/tree/master/public/model) and store it with the front-end.
